...
#'   strictly between 0 and 1. If `af` has names, they are used as row names of the
#'   returned genotype matrix. If names are absent, variant names are generated as
#'   `var1`, `var2`, ...
...
#' af <- c(rs1 = 0.10, rs2 = 0.25, rs3 = 0.40)
